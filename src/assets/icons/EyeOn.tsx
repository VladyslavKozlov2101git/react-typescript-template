...
const EyeOn = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path
        d="M15.5801 12C15.5801 13.98 13.9801 15.58 12.0001 15.58C10.0201 15.58 8.42009 13.98 8.42009 12C8.42009 10.02 10.0201 8.42 12.0001 8.42C13.9801 8.42 15.5801 10.02 15.5801 12Z"
        stroke="#B8B8B8"
        strokeWidth="1.5"
        strokeLinecap="round"
